...
jest.mock("@/app/(admin)/dashboard/categories/columns", () => ({
  categoriesColumns: [{ accessorKey: "name" }],
}))
...
describe("Categories Page", () => {
  ...
  describe("empty state", () => {
    ...
    it("shows add category link", async () => {
      ...
      expect(link).toHaveAttribute("href", "/dashboard/categories/create")
    })
  })
  ...
  describe("error state", () => {
    it("propagates fetch errors", async () => {
      ...
      mockedGetCategoriesTable.mockRejectedValue(error)
